...
src/gui/mainwindow_moc.o: src/gui/mainwindow_moc.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@

src/gui/mainwindow_moc.cpp: src/gui/MainWindow.h
	$(QT_PATH)/bin/moc $< -o $@
	
src/gui/videowidget_moc.o: src/gui/videowidget_moc.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@
...
src/gui/TimerHandler.o: src/gui/TimerHandler.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@

src/gui/timerhandler_moc.o: src/gui/timerhandler_moc.cpp
	$(CXX) $(CXXFLAGS) -c $< -o $@
